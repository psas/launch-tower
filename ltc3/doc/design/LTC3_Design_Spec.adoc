...
Photovoltaic panels; lab power.  TODO

Minimum input voltage is determined by the DC-DC converter supplying
the 19 VDC rail, which requires an overhead of 4 VDC.  A 24 VDC supply
capable of sourcing at least TODO: xx amps will suffice.
...
LTC3 provides three DC power rails: 5 VDC for the Beaglebone and cape;
12 VDC for the Ethernet switch and external device support; and 19 VDC
for rocket shore power.
