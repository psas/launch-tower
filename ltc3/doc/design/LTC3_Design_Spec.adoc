...
Technologies LTC2991] *Octal I2C Voltage, Current, and Temperature
Monitor* ICs.  One IC is dedicated to the LTC3's power sources,
another other to its sinks.  The LTC2991 ICs interface with the
BeagleBone via an I2C bus.
